      ...
      <div className="mx-auto max-w-3xl px-6 py-16 pt-14 sm:py-38  lg:px-8 lg:py-48">
        ...
        <div className="mt-6 text-lg leading-8 text-gray-600">
          <div>
            ...
            producer who knows how to bring out the best in your video interview
            – the first step in crafting an incredible video resumé. While you
            wait, check out the below 60-second video for helpful tips on how to
            set your video interview up for success.
          </div>
          <ol
          ...
          >
            ...
            <li>
              Have Fun (There&apos;s no stress here! Our mission is to help you
              look, feel and present as smart, confident, articulate and
          ...
          <div className="text-center mt-6 font-semibold text-gray-900">
            Schedule your time below, we look forward to our interview with you!
          </div>
        </div>
        <div className="mt-12">
          <Calendly />
