        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-38 lg:py-48">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Tired of wasting your time sending out dozens of resumes
              only to hear crickets? Let SeeV help you stand out from the
              crowd with a dynamic, custom video resume that showcases
              your experience in the best ways possible.
            </p>
